...
namespace Social.Application.Files
{
    public class AddFiles
    {
        ...
        public async void Do(List<DocsModel> docs, ChildDTO childInfo, RepresentDTO representInfo, ServisesSocial servises)//Должен принять Servises, Child, Represent
        {
